defmodule MedishopWeb.Components.Spinner do
  @moduledoc """
  The `MedishopWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `MedishopWeb.Components.Spinner` module enables developers to provide
