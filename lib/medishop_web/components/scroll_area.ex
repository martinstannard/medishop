defmodule MedishopWeb.Components.ScrollArea do
  @moduledoc """
  The `MedishopWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
