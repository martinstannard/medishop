defmodule MedishopWeb.Components.CheckboxCard do
  @moduledoc """
  The `MedishopWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
