defmodule MedishopWeb.Components.Stepper do
  @moduledoc """
  The `MedishopWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `MedishopWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
