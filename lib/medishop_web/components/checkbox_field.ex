defmodule MedishopWeb.Components.CheckboxField do
  @moduledoc """
  MedishopWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
