defmodule MedishopWeb.Components.Combobox do
  @moduledoc """
  The `MedishopWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
