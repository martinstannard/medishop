defmodule MedishopWeb.Components.Alert do
  @moduledoc """
  MedishopWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
