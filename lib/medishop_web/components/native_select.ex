defmodule MedishopWeb.Components.NativeSelect do
  @moduledoc """
  The `MedishopWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `MedishopWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MedishopWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MedishopWeb.Gettext, "errors", msg, opts)
    end
  end
end
