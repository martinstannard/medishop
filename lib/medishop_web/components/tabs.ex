defmodule MedishopWeb.Components.Tabs do
  @moduledoc """
  `MedishopWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import MedishopWeb.Components.Badge, only: [badge: 1]
