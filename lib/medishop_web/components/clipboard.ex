defmodule MedishopWeb.Components.Clipboard do
  @moduledoc """
  The `MedishopWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
