defmodule MedishopWeb.Components.Menu do
  @moduledoc """
  The `MedishopWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `MedishopWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import MedishopWeb.Components.Button, only: [button_link: 1]
