defmodule MedishopWeb.Components.Overlay do
  @moduledoc """
  The `MedishopWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `MedishopWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
