defmodule MedishopWeb.Router do
  use MedishopWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MedishopWeb.Layouts, :root}
  ...
  scope "/api/json" do
    ...
    forward "/", MedishopWeb.AshJsonApiRouter
  end
  ...
  scope "/", MedishopWeb do
    ...
    confirm_route Medishop.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [MedishopWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Medishop.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [MedishopWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end
  ...
  if Application.compile_env(:medishop, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MedishopWeb.Telemetry
